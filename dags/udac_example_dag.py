...
default_args = {
    ...
    'email' : ['hamad.alaqeel96@gmail.com'],
...
dag = DAG('udac_example_dag',
          ...
          schedule_interval='0 * * * *', #This means hourly
          catchup=False
        )
...
stage_events_to_redshift = StageToRedshiftOperator(
    ...
    s3_key= 'log_data',
    file_type = 'JSON "s3://udacity-dend/log_data_path.json"'
)
...
stage_songs_to_redshift = StageToRedshiftOperator(
    ...
    s3_bucket = 'udacity-dend',
    s3_key= 'log_data',
    file_type = "JSON 'auto' COMPUPDATE OFF"
)
